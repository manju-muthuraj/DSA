...
Let’s call the new interval ‘a’ and the first interval with the above condition
...
Time complexity #
As we are iterating through all the intervals only once, the time complexity of the above algorithm is O(N)O(N)O(N), where ‘N’ is
