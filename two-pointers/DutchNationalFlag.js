...
which will take O(N∗logN)O(N*logN)O(N∗logN).
...
Let’s say the two pointers are called low and high which are pointing to the first and
the last element of the array respectively.
